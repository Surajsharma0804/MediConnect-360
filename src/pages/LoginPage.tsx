      ...
      <div className="max-w-md w-full glass-panel p-8">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            disabled={isLoading}
            className="w-full py-2 px-4 bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 rounded-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            ...
            {isLoading ? "Redirecting..." : (isLogin ? "Sign in with Google" : "Sign up with Google")}
          </button>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-2 px-4 bg-[#24292e] hover:bg-[#1b1f23] text-white rounded-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            ...
            {isLoading ? "Redirecting..." : (isLogin ? "Sign in with GitHub" : "Sign up with GitHub")}
          </button>
        </div>
